...
import { append, append_builder, concat, from_string, join, to_string } from "../../gleam_stdlib/gleam/string_builder.mjs";
  ...
  return ((k) => {
    return $html.script(
      ...
      (() => {
        ...
        let _pipe$1 = append_builder(_pipe, concat(k()));
