...
-file("/Users/hayleigh/work/lustre-labs/lustre/src/lustre/attribute.gleam", 27).
-spec attribute(binary(), binary()) -> lustre@internals@vdom:attribute(any()).
attribute(Name, Value) ->
    {attribute, Name, gleam_stdlib:identity(Value), false}.

-file("/Users/hayleigh/work/lustre-labs/lustre/src/lustre/attribute.gleam", 39).
-spec property(binary(), any()) -> lustre@internals@vdom:attribute(any()).
property(Name, Value) ->
    {attribute, Name, gleam_stdlib:identity(Value), true}.

-file("/Users/hayleigh/work/lustre-labs/lustre/src/lustre/attribute.gleam", 44).
-spec on(
    binary(),
    fun((gleam@dynamic:dynamic_()) -> {ok, OGX} |
        {error, list(gleam@dynamic:decode_error())})
) -> lustre@internals@vdom:attribute(OGX).
on(Name, Handler) ->
    {event, <<"on"/utf8, Name/binary>>, Handler}.

-file("/Users/hayleigh/work/lustre-labs/lustre/src/lustre/attribute.gleam", 63).
-spec map(lustre@internals@vdom:attribute(OHC), fun((OHC) -> OHE)) -> lustre@internals@vdom:attribute(OHE).
map(Attr, F) ->
    case Attr of
...
-file("/Users/hayleigh/work/lustre-labs/lustre/src/lustre/attribute.gleam", 78).
...
-file("/Users/hayleigh/work/lustre-labs/lustre/src/lustre/attribute.gleam", 90).
-spec class(binary()) -> lustre@internals@vdom:attribute(any()).
class(Name) ->
    attribute(<<"class"/utf8>>, Name).

-file("/Users/hayleigh/work/lustre-labs/lustre/src/lustre/attribute.gleam", 52).
-spec none() -> lustre@internals@vdom:attribute(any()).
none() ->
    class(<<""/utf8>>).

-file("/Users/hayleigh/work/lustre-labs/lustre/src/lustre/attribute.gleam", 95).
...
-file("/Users/hayleigh/work/lustre-labs/lustre/src/lustre/attribute.gleam", 164).
-spec msg(binary()) -> lustre@internals@vdom:attribute(any()).
msg(Uri) ->
    attribute(<<"msg"/utf8>>, Uri).

-file("/Users/hayleigh/work/lustre-labs/lustre/src/lustre/attribute.gleam", 169).
-spec autocomplete(binary()) -> lustre@internals@vdom:attribute(any()).
autocomplete(Name) ->
    attribute(<<"autocomplete"/utf8>>, Name).

-file("/Users/hayleigh/work/lustre-labs/lustre/src/lustre/attribute.gleam", 174).
