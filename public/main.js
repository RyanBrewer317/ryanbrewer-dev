...
var $author$project$Main$init = {output: ''};
...
var $author$project$Main$NewCode = function (a) {
	return {$: 'NewCode', a: a};
};
											...
											function (gen4, _var) {
												return A2(
														...
														return A2(
															...
															function (_v5) {
																...
																return A3(
																	...
																	gen6,
																	A3($elm$core$Dict$insert, v, bar2, scope),
																	e);
															},
													...
													A3(
														...
														gen4,
														scope,
														A3($author$project$Main$rename, v, 'x_' + _var, foo)));
											}));
								} else {
